...
bool testIncrementInterator() {
    ...
    ++testIt01;
    allPassed = allPassed ? (*testIt01) == "ball" : allPassed;
    ++testIt01;
    allPassed = allPassed ? (*testIt01) == "boy" : allPassed;
    ++testIt01;
    allPassed = allPassed ? (*testIt01) == "sure" : allPassed;
    ++testIt01;
    allPassed = allPassed ? (*testIt01) == "soup" : allPassed;
    ++testIt01;
    allPassed = allPassed ? testIt01 == testTrie.end() : allPassed;
